...
public class PatientsController : ApiController
{
    ...
    private readonly IGetAllPatientQuery _getAllPatientQuery;
    ...
    public PatientsController(
        ...
        IGetAllPatientQuery getAllPatientQuery)
        : base(logger)
    {
        ...
        _getAllPatientQuery = getAllPatientQuery;
    }
    ...
    [HttpGet]
    public async Task<IActionResult> GetAllPatients([FromQuery]GetAllPatientRequest request, CancellationToken cancellationToken)
    {
        var result = await _getAllPatientQuery.Handle(request, cancellationToken);
        return result.IsSuccess
            ? Ok(result.Value)
            : HandleFailure(result);
    }
